...
export function PlayerCard({
  ...
  if (variant === "compact") {
    return (
      <Link
        ...
        className="flex items-center gap-3 rounded-2xl border border-stone-300/60 bg-[#F8F7F2] p-3 shadow-sm transition-transform active:scale-[0.99]"
      >
  ...
  return (
    <div className="flex flex-col gap-4 rounded-2xl border border-stone-300/60 bg-[#F8F7F2] p-5 shadow-sm">
